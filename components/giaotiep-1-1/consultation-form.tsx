            ...
            <div className="space-y-8">
              {[
                ...
                <div key={i} className="flex flex-col gap-2">
                  <span className="text-[10px] font-bold uppercase tracking-[2px] text-[#B6914C]">Outcome {outcome.id}</span>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-7 bg-white p-10 md:p-16 lg:p-20">
            <form className="space-y-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
                ...
                {/* Field: Phone */}
                <div className="relative group">
                  <input type="tel" id="academic-phone" placeholder=" " className="peer w-full bg-transparent border-b-2 border-slate-200 py-3 text-[#191c1c] outline-none focus:border-[#B6914C] transition-all duration-300 rounded-none placeholder-transparent font-body" />
                  <label htmlFor="academic-phone" className="absolute left-0 -top-4 text-[10px] font-bold uppercase tracking-[1.5px] text-[#B6914C] transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:font-normal peer-placeholder-shown:text-slate-400 peer-placeholder-shown:top-3 peer-focus:-top-4 peer-focus:text-[10px] peer-focus:font-bold peer-focus:text-[#B6914C]">
                    Số điện thoại
                  </label>
                </div>
                ...
                <div className="relative group md:col-span-2">
                  <input type="email" id="academic-email" placeholder=" " className="peer w-full bg-transparent border-b-2 border-slate-200 py-3 text-[#191c1c] outline-none focus:border-[#B6914C] transition-all duration-300 rounded-none placeholder-transparent font-body" />
                  <label htmlFor="academic-email" className="absolute left-0 -top-4 text-[10px] font-bold uppercase tracking-[1.5px] text-[#B6914C] transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:font-normal peer-placeholder-shown:text-slate-400 peer-placeholder-shown:top-3 peer-focus:-top-4 peer-focus:text-[10px] peer-focus:font-bold peer-focus:text-[#B6914C]">
                    Email liên hệ
                  </label>
                </div>
                ...
                {/* Field: Objective */}
                <div className="relative group md:col-span-2">
                  <input type="text" id="academic-objective" placeholder=" " className="peer w-full bg-transparent border-b-2 border-slate-200 py-3 text-[#191c1c] outline-none focus:border-[#B6914C] transition-all duration-300 rounded-none placeholder-transparent font-body" />
                  <label htmlFor="academic-objective" className="absolute left-0 -top-4 text-[10px] font-bold uppercase tracking-[1.5px] text-[#B6914C] transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:font-normal peer-placeholder-shown:text-slate-400 peer-placeholder-shown:top-3 peer-focus:-top-4 peer-focus:text-[10px] peer-focus:font-bold peer-focus:text-[#B6914C]">
                    Mục tiêu học tập
                  </label>
                </div>
              </div>
