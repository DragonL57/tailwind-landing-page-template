        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <button onClick={() => document.getElementById('form')?.scrollIntoView({ behavior: 'smooth' })} className="inline-flex items-center justify-center w-full bg-brand-dark text-white py-5 font-bold tracking-[1px] text-sm hover:bg-brand-crimson transition-all group/btn cursor-pointer">
