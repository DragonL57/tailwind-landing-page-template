...
export default function Hero() {
  return (
    <section className="relative min-h-[calc(100vh-4rem)] lg:h-[calc(100vh-4rem)] flex flex-col justify-center bg-white overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto w-full px-6 md:px-12 py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 z-10">
            ...
            <div className="space-y-4 text-base md:text-lg text-[#5b403f] font-body leading-relaxed max-w-2xl mb-8">
            ...
            {/* Feature Bullets */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-6 mb-8 max-w-2xl border-t border-b border-slate-200 py-6">
              {[
