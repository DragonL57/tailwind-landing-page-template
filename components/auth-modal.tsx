...
export default function AuthModal({ isOpen, onCloseAction, initialMode = "login" }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-in fade-in">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto animate-in zoom-in-95 slide-in-from-bottom-4">
        {/* Close button */}
        <button
          onClick={onCloseAction}
        ...
        <div className="p-8 pb-6">
          ...
          <h2 className="text-3xl font-bold text-center text-vmg-navy mb-2">
        ...
        <form onSubmit={handleSubmit} className="px-8 pb-8 space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-vmg-blue to-vmg-navy hover:from-vmg-navy hover:to-vmg-blue text-white font-bold py-3 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.02]"
          >
            {mode === "login" ? "Đăng Nhập" : "Đăng Ký"}
          </button>
          ...
          <div className="text-center pt-4 border-t border-gray-200 mt-6">
            <p className="text-gray-600">
              ...
              <button
                ...
                className="text-vmg-blue hover:text-vmg-navy font-semibold"
              >
