    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-white/80 backdrop-blur-xl border-b-2 border-brand-gold">
      <div className="flex justify-between items-center px-6 md:px-12 h-16">
        ...
        <div className="hidden lg:flex gap-10 h-full items-center">
          ...
          >
            <button className="flex items-center gap-2 text-slate-600 font-bold hover:text-brand-crimson transition-colors font-body text-xs md:text-sm tracking-[1.5px] uppercase">
              Các khóa học
              <svg
            ...
            {coursesDropdownOpen && (
              <div className="absolute top-full left-0 w-64 bg-white border-2 border-brand-gold/20 overflow-hidden animate-in fade-in slide-in-from-top-2 z-50">
