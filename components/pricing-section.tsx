    ...
    <FadeSlideUp id="pricing-final" className="w-full bg-[#0038D1] section-padding scroll-mt-24 overflow-hidden relative">
      ...
      <div className="w-full px-4 relative z-10">
        <div className="max-w-[1200px] mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row border border-white/20">
          ...
          {/* Right: Pricing & CTA */}
          <div className="w-full md:w-96 bg-gray-50/50 p-8 md:p-12 flex flex-col justify-center items-center text-center">
            <span className="text-[10px] font-black text-[#0038D1] uppercase tracking-[0.2em] mb-2">Học phí trọn gói</span>
            <div className="mb-6">
              {isApplied && (
                <div className="flex flex-col items-center mb-1">
                  <span className="text-sm text-gray-400 line-through font-bold italic leading-none">
              ...
              <span className="text-5xl font-black text-gray-900 tracking-tighter tabular-nums leading-tight block">
            ...
            <div className="w-full max-w-[300px] mb-8">
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full pl-4 pr-20 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0038D1]/20 transition-all text-xs font-bold uppercase tracking-widest"
                />
                <button
                  onClick={handleApplyDiscount}
                  className={`absolute right-1.5 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase transition-all ${
                    isApplied 
                      ? 'bg-[#75E04D] text-white' 
                      : 'bg-[#0038D1] text-white hover:bg-[#002bb1]'
                  }`}
                >
