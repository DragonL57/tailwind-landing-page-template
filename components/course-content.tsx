      ...
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
          ...
          <div className="md:col-span-8 p-10 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col items-start hover:border-vmg-blue/30 transition-all duration-300 relative overflow-hidden group">
            <div className="absolute -bottom-6 -right-4 text-[160px] font-black text-vmg-blue/10 leading-none select-none pointer-events-none transition-all duration-500 group-hover:scale-110 group-hover:text-vmg-blue/15">1</div>
          ...
          <div className="md:col-span-4 p-10 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col items-start hover:border-vmg-blue/30 transition-all duration-300 relative overflow-hidden group">
            <div className="absolute -bottom-4 -right-2 text-[120px] font-black text-vmg-blue/10 leading-none select-none pointer-events-none transition-all duration-500 group-hover:scale-110 group-hover:text-vmg-blue/15">2</div>
            <div className="relative z-10">
          ...
          <div className="md:col-span-4 p-10 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col items-start hover:border-vmg-blue/30 transition-all duration-300 relative overflow-hidden group">
            <div className="absolute -bottom-4 -right-2 text-[120px] font-black text-vmg-blue/10 leading-none select-none pointer-events-none transition-all duration-500 group-hover:scale-110 group-hover:text-vmg-blue/15">3</div>
            <div className="relative z-10">
          ...
          {/* Card 4: Internship */}
          <div className="md:col-span-4 p-10 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col items-start hover:border-vmg-blue/30 transition-all duration-300 relative overflow-hidden group">
            <div className="absolute -bottom-4 -right-2 text-[120px] font-black text-vmg-blue/10 leading-none select-none pointer-events-none transition-all duration-500 group-hover:scale-110 group-hover:text-vmg-blue/15">4</div>
            <div className="relative z-10">
          ...
          {/* Card 5: Career Path */}
          <div className="md:col-span-4 p-10 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col items-start hover:border-vmg-blue/30 transition-all duration-300 relative overflow-hidden group">
            <div className="absolute -bottom-4 -right-2 text-[120px] font-black text-vmg-blue/10 leading-none select-none pointer-events-none transition-all duration-500 group-hover:scale-110 group-hover:text-vmg-blue/15">5</div>
            <div className="relative z-10">
